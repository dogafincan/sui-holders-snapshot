...
function ItemTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "line-clamp-1 flex w-fit items-center gap-2 text-base leading-snug font-semibold underline-offset-4",
        className,
      )}
      {...props}
    />
...
function ItemDescription({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
      ...
      className={cn(
        "line-clamp-2 text-left text-base font-normal text-muted-foreground [&>a]:underline [&>a]:underline-offset-4 [&>a:hover]:text-primary",
        className,
      )}
      {...props}
    />
